...
<head>
    ...
    define('bankName', 'National Bank',true);
...
<h1 class="alert alert-success rounded-0"><?php echo bankname; ?><small class="float-right text-muted" style="font-size: 22pt;"><kbd>Presented by:Isha Zade</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
